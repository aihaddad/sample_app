...
describe "Authentication" do
  ...
  describe "authorization" do
    ...
    describe "for non-signed-in users" do
      ...
      describe "when attempting to vists a protected page" do
        before do 
      ...
      describe "in the Microposts controller" do
        ...
        describe "submitting to the create action" do
          ...
          specify { expect(response).to redirect_to(signin_path) } # no underscore in "signin path" in the book
        end

        describe "submitting to the destroy action" do
          before { delete micropost_path(FactoryGirl.create(:micropost)) } # notice singular "micropost"
          specify { expect(response).to redirect_to(signin_path) }
        end
      end
